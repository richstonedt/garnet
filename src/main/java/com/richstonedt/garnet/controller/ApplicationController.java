...
public class ApplicationController {
    ...
    public ResponseEntity<?> createApplication(
        ...
        try {
            ...
            LOG.error(error, t);
            GarnetMessage<GarnetErrorResponseMessage> torinoSrcMessage = MessageUtils.setMessage(MessageCode.FAILURE, MessageStatus.ERROR, error, new GarnetErrorResponseMessage(ERROR));
